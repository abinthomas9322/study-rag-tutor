...
- [x] 9.2 Deploy free + live demo link
  - Live: backend on Render (Docker, free), frontend on Vercel (free), CORS
    locked to the Vercel origin. /health self-reports build metadata
    (demo_seeded: true). Live demo URL added to README.
